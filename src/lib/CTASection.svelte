...
<section id="cta" class="cta-section">
  <div class="container">
    <div class="cta-shell">
      <div class="cta-copy">
        <span class="eyebrow">Pilot Aico</span>
        <h2>Spin up your voice agent pilot in days, not months.</h2>
        <p>
          Share a work email and our team will schedule a working session. Bring your call flows, tools, and success metrics—we’ll show you how Aico maps to them instantly.
        </p>
      ...
      <div class="cta-panel">
        ...
        <div class="panel-footnote">
          ...
          Prefer async? <a href="mailto:hello@aico.ai">Email our team</a> with your goals.
        </div>
      </div>
    </div>
  </div>
